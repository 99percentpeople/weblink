      ...
      >
        ...
        <div class="meeting-controls-group">
          ...
          <button
            ...
            onClick={() => void props.media.toggleSharing()}
          >
            <Show
          ...
          >
            <button
              ...
              onClick={() => void props.media.addSharing()}
            >
              <Plus />
        ...
        <button
          ...
          aria-label={t("meeting.leave_room")}
          title={t("meeting.leave_room")}
        >
          <PhoneOff />
          <span>{t("meeting.leave_room")}</span>
        </button>
      </Motion.footer>
    </AnimatePresence>
  );
